...
export const registering = (payload) => dispatch => {
    ...
    Axios.post("http://ec2-13-40-34-74.eu-west-2.compute.amazonaws.com:2244/register", {
        ...payload
    }).then((res) => {
...
export const SignInlogin = (payload) => dispatch => {
    ...
    Axios.post("http://ec2-13-40-34-74.eu-west-2.compute.amazonaws.com:2244/login", {
        ...payload
    }).then((res) => {
...
export const tweet = (payload) => dispatch => {
    ...
    Axios.patch(`http://ec2-13-40-34-74.eu-west-2.compute.amazonaws.com:2244/users/${payload.id}`, {
...
export const follow1 = (payload) => dispatch => {
    // console.log(payload);
    Axios.patch(`http://ec2-13-40-34-74.eu-west-2.compute.amazonaws.com:2244/users/follow/${payload.mine}`, {
        follow: payload.sec
    }).then((res) => {
        console.log(res.data.data);
